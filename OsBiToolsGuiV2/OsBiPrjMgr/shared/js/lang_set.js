...
(function(osbi) {
  osbi.load_ll_set({
    ...
    LL_ERROR_WS_NOT_AVAILABLE: { 
      "en": "Background WebS ervice Not Available",
    ...
    LL_INSTALL_MSG: {
      "en": "OsBiTools UI successfully installed.",
      "fr": "Le UI OsBiTools a été installé avec succès.",
      "ru": "OsBiTools UI успешно установлен.",
      "es": "OsBiTools UI instalado con éxito.",
      "de": "OsBiTools UI erfolgreich installiert."
    }
